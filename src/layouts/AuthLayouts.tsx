      ...
      <div className="flex flex-col items-center justify-center">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-lg rounded-full px-6 py-2 border border-white/20 animate-fade-in">
            ...
            <span className="text-white/90 text-sm font-medium">Now Live</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-white/80 max-w-2xl mx-auto font-light">
            Connect, collaborate, and create meaningful relationships that grow
            with your vision
          </p>
        </div>
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
    ...
    <div>
      ...
      <ul className="space-y-2 text-gray-400">
        ...
        <li className="hover:text-indigo-400 transition">Privacy policy</li>
        <li className="hover:text-indigo-400 transition">Cookie policy</li>
      </ul>
    </div>
